package com.alipay.APPNAME.endpoint.facade;


import com.alipay.APPNAME.endpoint.constants.URLConstants;
import com.alipay.APPNAME.endpoint.exception.APPNAMECommonException;
import com.alipay.APPNAME.endpoint.constants.RestAPPNAMEConstants;
...
@Consumes(RestAPPNAMEConstants.DEFAULT_CONTENT_TYPE)
@Produces(RestAPPNAMEConstants.DEFAULT_CONTENT_TYPE)
