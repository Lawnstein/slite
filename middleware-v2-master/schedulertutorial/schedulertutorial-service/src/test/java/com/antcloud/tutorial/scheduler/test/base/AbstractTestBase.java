package com.antcloud.tutorial.scheduler.test.base;

import com.antcloud.tutorial.scheduler.Slite2SpringBootApplication;
...
@ImportResource({"classpath*:test/META-INF/schedulertutorial/test.xml"})
