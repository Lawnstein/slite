package com.antcloud.tutorial.mq.web.test.base;

import com.antcloud.tutorial.mq.Slite2WebSpringBootApplication;
...
@SpringBootTest(classes = Slite2WebSpringBootApplication.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
