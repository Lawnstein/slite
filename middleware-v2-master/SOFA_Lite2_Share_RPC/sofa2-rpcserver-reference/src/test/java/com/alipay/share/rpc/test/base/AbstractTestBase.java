package com.alipay.share.rpc.test.base;

import com.alipay.share.rpc.reference.Slite2SpringBootApplication;
...
@ImportResource({"classpath*:test/META-INF/sofa2-rpcserver/test.xml"})
